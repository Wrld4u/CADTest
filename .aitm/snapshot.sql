...
INSERT INTO epics (id,title,summary,priority,status,created_at) VALUES (2,'Оптимизация бронирования: Redis pre-check','Добавить Redis ускоритель для conflict-path и сравнить mixed-нагрузку','P1','active','2026-03-19 13:35:19 +0000 UTC');
...
INSERT INTO tasks (id,epic_id,title,status,priority,order_in_epic,estimate,created_at) VALUES (6,2,'Интегрировать Redis pre-check в POST /reserve','doing','P1',1,NULL,'2026-03-19 13:35:30 +0000 UTC');
COMMIT;
